...
public class LineSort {
	...
	public static void sortLines(String filePath, String outfilePath) throws IOException{
	...
	//Divide a big file into several small files which have at most MaxLine lines.
	private static ArrayList<String> divParts(String filePath) throws IOException{
	...
	//Union small files.
	private static void unionParts(ArrayList<String> partFilePaths, String outFilePath) throws IOException{
	...
	public static void main(String[] args) {
		String filePath1 = "E:/LXResearch/Codes/GetTrainingData/results/external_links.txt";
		String filePath2 = "E:/LXResearch/Codes/GetTrainingData/results/instance_types.txt";
		try {
